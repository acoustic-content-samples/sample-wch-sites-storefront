...
describe('Sample OOB SPA tests', function() {
	...
	it('should be able to see logo in the header', function() {
		...
		expect(this.header.logo()).toContain('04302605596010f57e8cd45f06c2c43e.svg');
	});
	...
	it('should be able to navigate', function() {
		...
		expect(standardPage.heroImage()).toContain("1c2111ea5e20d25a5502696ceb6dfae9.jpg?resize=1200px%3A800px&crop=1200%3A300%3B0%2C250");
		//AND hero message is displayed in the hero image
		expect(standardPage.heroMessage()).toEqual("Modern textures for living spaces");
	});
	...
	it('should be able to see logo in the footer', function() {
		...
		expect(this.footer.logo()).toContain("daa742706465d24b624464b77b0cc6c0.svg");
	});
	...
	it('should be able to get footer info', function() {
		...
		expect(this.footer.customerServiceNumber()).toEqual("+1 (888) 777-5555");
	});
